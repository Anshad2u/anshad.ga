				...
				?>
					<li id="li-comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
						<article id="comment-<?php comment_ID(); ?>" class="comment">
							...
							<div class="reply">
								<?php
									comment_reply_link( array_merge( $args, array(  'reply_text' => __( 'Reply', 'empathy' ),
																					'after'      => "",
																					'depth'      => $depth,
...
/* ============================================================================================================================================= */
	...
	{
		register_sidebar( array('name'          => __( 'Footer 1', 'empathy' ),
		...
		register_sidebar( array('name'          => __( 'Footer 2', 'empathy' ),
		...
		register_sidebar( array('name'          => __( 'Footer 3', 'empathy' ),
		...
		register_sidebar( array('name'          => __( 'Footer Social Icons', 'empathy' ),
		...
		register_sidebar( array('name'          => __( 'Footer Copyright Text', 'empathy' ),
								'id'            => 'pixelwars__sidebar_3',
								'description'   => __( 'Use Text widget in here.', 'empathy' ),
		...
		register_sidebar( array('name'          => __( 'Empathy Template Pages', 'empathy' ),
...
/* ============================================================================================================================================= */
	...
	class pixelwars__Widget__Custom_Page extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct('pixelwars__widget__custom_page',
								...
								array( 'description' => __( 'About, resume, contact etc.', 'empathy' ) ) );
		}
			...
			?>
				<table style="width: 100%; margin-top: 5px;">
					...
					<tr>
						...
						<td>
							<span style="display: inline-block; margin-bottom: 5px; font-size: 11px; color: #999999;"><?php echo __('For page icon and menu icon.', 'empathy'); ?> <?php echo __('Use icon name.', 'empathy'); ?> <?php echo __('Available', 'empathy'); ?> <a target="_blank" href="http://themes-pixeden.com/font-demos/7-stroke/"><?php echo __('icons', 'empathy'); ?></a>.</span>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<span style="font-size: 11px; color: #999999;"><?php echo __('Select a page for this widget.', 'empathy'); ?></span>
						</td>
					</tr>
				</table>
	...
	add_action('widgets_init', function() { register_widget('pixelwars__Widget__Custom_Page'); });
...
/* ============================================================================================================================================= */
		...
		public function form($instance)
		{
			...
			?>
				...
				<table style="width: 100%; margin-top: 5px;">
					<tr>
						<td>
							<label for="<?php echo esc_attr($this->get_field_id('background_video')); ?>"><?php esc_html_e('Background Video', 'empathy'); ?></label>
						</td>
					</tr>
					<tr>
						<td>
							...
							<span style="font-size: 11px; color: #999999;"><?php esc_html_e('Use browser address url of a video from YouTube or Vimeo.', 'empathy'); ?></span>
						</td>
					</tr>
				</table>
	...
	add_action('widgets_init', function() { register_widget('pixelwars__Widget__Home'); });
...
/* ============================================================================================================================================= */
	...
	class pixelwars__Widget__Blog extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct('pixelwars__widget__blog',
								...
								array( 'description' => __( 'Latest blog posts.', 'empathy' ) ) );
		}
		...
		public function form( $instance )
		{
			...
			?>
				<table style="width: 100%; margin-top: 5px;">
					...
					<tr>
						<td>
							<label for="<?php echo $this->get_field_id( 'blog_page_slug' ); ?>"><?php echo __( 'Page', 'empathy' ); ?></label>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<span style="display: inline-block; margin-bottom: 5px; font-size: 11px; color: #999999;"><?php echo __('Select a page for this widget.', 'empathy'); ?></span>
						</td>
					</tr>
					<tr>
						<td>
				...
				<table style="width: 100%; margin-top: 5px;">
					<tr>
						<td style="width: 80px;">
							<label for="<?php echo $this->get_field_id( 'blog_item_width' ); ?>"><?php echo __( 'Item Width', 'empathy' ); ?></label>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<span style="display: inline-block; margin-bottom: 5px; font-size: 11px; color: #999999;"><?php echo __('Default: 340 (px)', 'empathy'); ?></span>
						</td>
					</tr>
					<tr>
						<td>
	...
	add_action('widgets_init', function() { register_widget('pixelwars__Widget__Blog'); });
...
/* ============================================================================================================================================= */
	...
	class pixelwars__Widget__Portfolio extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct('pixelwars__widget__portfolio',
								...
								array( 'description' => __( 'Portfolio items.', 'empathy' ) ) );
		}
		...
		public function form( $instance )
		{
			...
			?>
				<table style="width: 100%; margin-top: 5px;">
					...
					<tr>
						<td>
							<label for="<?php echo $this->get_field_id( 'portfolio_page_slug' ); ?>"><?php echo __( 'Page', 'empathy' ); ?></label>
						</td>
						<td>
				...
				<table style="width: 100%; margin-top: 5px;">
					<tr>
						<td style="width: 80px;">
							<label for="<?php echo $this->get_field_id( 'item_width' ); ?>"><?php echo __( 'Item Width', 'empathy' ); ?></label>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<span style="font-size: 11px; color: #999999;"><?php echo __('Default: 340 (px)', 'empathy'); ?></span>
						</td>
					</tr>
				</table>
	...
	add_action('widgets_init', function() { register_widget('pixelwars__Widget__Portfolio'); });
